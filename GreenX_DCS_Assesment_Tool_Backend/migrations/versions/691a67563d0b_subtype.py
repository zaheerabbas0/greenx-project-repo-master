...
Revision ID: 691a67563d0b
Revises: 
Create Date: 2024-08-24 07:16:40.616279
...
def upgrade():
    ...
    sa.Column('improvement', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    op.create_index(op.f('ix_answers_weight'), 'answers', ['weight'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_answers_weight'), table_name='answers')
