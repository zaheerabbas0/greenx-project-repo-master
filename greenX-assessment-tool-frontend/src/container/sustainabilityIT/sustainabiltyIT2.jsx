...
const SustainabiltyIT2 = () => {
  ...
  // console.log("details.....", details?.sustainabiltyIT);
        ...
        <Container>
          <div>
            <Title>
              ...
              {questionAns[1]?.framework_name}
            </Title>
            <HorizontalProgress />
            {questionAns[1]?.subtypes_values?.map((data, index) => (
              <div
                key={index}
...
export default SustainabiltyIT2;
