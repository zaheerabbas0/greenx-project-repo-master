  ...
  const fetchSustainableIt = async () => {
    ...
    try {
      const res = await axios.get(
        baseUrl + `/api/v2/setup/get-all-question-answer`,
        {
          headers: {
        ...
        <Container>
          <div>
            <Title>
              ...
              {questionAns?.length > 0 && questionAns[0]?.framework_name}
            </Title>
            <HorizontalProgress />
            {questionAns?.length > 0 &&
              questionAns[0]?.subtypes_values?.map((data, index) => (
                <div
                  key={index}
                        ...
                        <Col lg={8}>
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                Consider the technological tools in place for
                                data safeguarding.
                              </p>
                              <p
                                style={{
